...
impl Rotation {
    ...
    pub const fn up(self) -> Face {
        unsafe { Face::from_u8_unchecked(self.as_u8() >> 2) }
    }
    ...
    pub const fn rotate_face(self, face: Face) -> Face {
        ...
        const TABLE: [[Face; 24]; 6] = {
            let mut table = [[crate::face::UsedAxisOrientation::UP; 24]; 6];
            ...
            loop {
                ...
                table[face_index as usize][rot_index as usize] = rotate_world(world_face, rot_face, rot_angle);
                if rot_index == 23 {
                    if face_index == 5 {
                        break;
                    }
        ...
        TABLE[face as usize][self as usize]
    }
